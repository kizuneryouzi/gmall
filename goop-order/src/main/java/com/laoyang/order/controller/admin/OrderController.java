package com.laoyang.order.controller.admin;
...
public class OrderController {
    ...
    public R<OrderVo> getOneByOrderSn(@PathVariable("orderSn") String orderSn) {
        OrderVo orderVo = orderService.getOneByOrderSn(orderSn);
