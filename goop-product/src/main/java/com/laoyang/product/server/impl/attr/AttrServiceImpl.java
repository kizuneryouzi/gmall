...
import com.laoyang.common.constant.ProductConstant;
import com.laoyang.common.util.PageUtils;
import com.laoyang.common.util.Query;
import com.laoyang.product.dao.AttrAttrgroupRelationDao;
...
public class AttrServiceImpl extends ServiceImpl<AttrDao, AttrEntity> implements AttrService {
    ...
    /**
     * 根据属性ids、获取其中可被检索的属性实体
     *
     * @param allAttrIdList
     * @return
     */
    @Override
    public List<AttrEntity> selectSearchAttr(List<Long> allAttrIdList) {
        return baseMapper.selectSearchAttrs(allAttrIdList);
    }
